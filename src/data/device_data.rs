...
impl DeviceData {
    ...
    pub fn to_record(&self, current_factor: f32, voltage_factor: f32) -> Vec<String> {
        ...
        vec![
            ...
            (self.pfl1 * current_factor * voltage_factor).to_string(),
            (self.pfl2 * current_factor * voltage_factor).to_string(),
            (self.pfl3 * current_factor * voltage_factor).to_string(),
            ...
            (self.u2u1max * voltage_factor).to_string(),
            (self.u0u1max * voltage_factor).to_string(),
            ...
            self.pfmin.to_string(),
            self.dpfmin.to_string(),
            ...
            self.io7.to_string(),
            self.io8.to_string(),
            self.ep10wh.to_string(),
            self.ep_10wh.to_string(),
            self.eq10varh.to_string(),
            self.eq_10varh.to_string(),
            self.eq1_pos.to_string(),
            self.eq1_neg.to_string(),
